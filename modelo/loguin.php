<?php 
    class loguin{
        ...
        function verificar(){
            $verificar = mysqli_query($this->_conexion,"SELECT rol , nik , password , noidentif FROM usuarios WHERE rol = '$this->_rol' and  nik = '$this->_nick' and password = '$this->_password' ") or die(mysqli_error($this->_conexion));
